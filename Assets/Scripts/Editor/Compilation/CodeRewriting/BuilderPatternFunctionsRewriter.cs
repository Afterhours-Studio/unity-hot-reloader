...
{
    class BuilderPatternFunctionsRewriter : UnityReloaderCodeRewriterBase
    {
        ...
        public override SyntaxNode VisitMethodDeclaration(MethodDeclarationSyntax node)
        {
            ...
            {
                var ancestorNameWithoutPatchedPostfix = ancestorName.Replace(UnityReloader.Runtime.AssemblyChangesLoader.ClassnamePatchedPostfix, "");
