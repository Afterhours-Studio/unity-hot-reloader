...
namespace UnityReloader.Editor.Compilation.ScriptGenerationOverrides
{
    [InitializeOnLoad]
...
";
        ...
        static ScriptGenerationOverridesManager()
        {
            ...
            //NOTE: folder name kept as legacy "FastScriptReload" so existing user-saved overrides are not orphaned after rebrand
